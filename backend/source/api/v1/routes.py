...
_add_router(resources.dummy.router, prefix=f"")
_add_router(resources.kakao.router, prefix=f"/{version}/kakao")
_add_router(resources.stock.router, prefix=f"/{version}/stock")
