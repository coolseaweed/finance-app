...
from source.core.static.urls import COOLSEAWEED, STONE82
...
def send_message(msg):
    return JSONResponse({"version": "2.0", "template": {"outputs": [{"simpleText": {"text": f"{msg}"}}]}})
...
#         return send_message(
#             f"이미지를 생성중 입니다.. 약 6~10초 뒤에 아래 url을 통해 이미지를 받을 수 있습니다. 해당 url은 1시간 후 만료됩니다 :)\n{tmp_image_url}"
#         )
